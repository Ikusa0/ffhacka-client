    ...
    <IonPage className="FiancaLocaticia">
      ...
      <IonContent className="content">
        <div className="contentBox">
          ...
          <div>
            <p>
              <img className="lista" src={require("./Ellipse.png")} /> Procure
              um lugar bem iluminado
            </p>
            <p>
              <img className="lista" src={require("./Ellipse.png")} /> Enquadre
              a imagem com os marcadores da tela
            </p>
            <p>
              <img className="lista" src={require("./Ellipse.png")} /> Tente
              manter a câmera parada
            </p>
          </div>
        </div>
        <IonButton
          className="permission ion-text-capitalize"
          href="/fiancaLocaticia2"
        >
          Tira foto
        </IonButton>
      </IonContent>
